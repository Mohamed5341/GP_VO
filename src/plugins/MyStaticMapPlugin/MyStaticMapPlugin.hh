...
#ifndef GAZEBO_PLUGINS_MYSTATICMAPPLUGIN_HH_
#define GAZEBO_PLUGINS_MYSTATICMAPPLUGIN_HH_
...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE MyStaticMapPlugin : public WorldPlugin
  {
    /// \brief Constructor.
    public: MyStaticMapPlugin();
